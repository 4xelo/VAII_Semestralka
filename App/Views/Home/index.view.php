    ...
    <div class="text">
        ...
        <p>Requirement engineering<br>
            Architecture and Design<br>
            SW implementation<br>
            Validation & Verification</p>
        <h2 >hardware development</h2>
        <p>HW Architecture<br>
            Preliminary Production Design<br>
            Design of Schematic Circuit Diagram<br>
            Design of Printed Circuit Board <br>
            Assembly, Evaluation, Programming and Debuging</p>
        <h2 >project management</h2>
        <p>Project tailoring<br>
            Initiating and planning<br>
            Executing, Monitoring and Controlling<br>
            Project closing<br>
            Different models (Agile, Traditional)</p>
        ...
        <p>Strong Project Management <br>
            Flexible Software Development <br>
